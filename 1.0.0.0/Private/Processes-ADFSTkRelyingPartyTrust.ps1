...
param (
    ...
    else
    {
        ...
        if ($ForceUpdate)
        {
            ...
            {
                Write-ADFSTkLog "'$($sp.EntityID)' in ADFS database, forcing update!"
        ...
        else
        {
            ...
            {
                Write-ADFSTkLog "Skipping RP due to -AddRemoveOnly switch..."
                Add-ADFSTkEntityHash -EntityID $sp.EntityID
            }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUJ50Nigz88DpgegFXichkBDzc
# 1SSgghKwMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTTH1GCUU2+2KTd/1qGSk8N3kuZ7TANBgkq
# hkiG9w0BAQEFAASCAQBKSnFPkQ+BcI9SNDfId4Q34KlvF3V0K5xR2DaMAq1Y3Qw+
# siJzkrrRs0+bjAcp2yKqTK9hNjez0veWnFYY7g2wyHV+lNhr4EXIMnBQHJNuMc+G
# PPb+kfdyxi1GfUr6oj29erKX9WAOJJ2Kjhxecsh+qZQYYWNQTFjmL6ZiMh7+rqk6
# BB6mZOhmbXDlCHZZgMR4W5SrQazeHX+8PqRmYLU4hcDmfV4+cP2knjR2K83rU75/
# OmWNfI7V7Zyo4HmfS/NzrDfuSzS6pEVvaw+QoJf6QjinHXZlCQWcUUK4+Gk2SA45
# +VV/0se/j52n6Qd3mJgvxzzgMTkF37BUjVGt700+oYICojCCAp4GCSqGSIb3DQEJ
...
# KoZIhvcNAQkEMRYEFENZ5N/Sksh7/kbsaLpPdYaiEhEKMIGdBgsqhkiG9w0BCRAC
...
# FDANBgkqhkiG9w0BAQEFAASCAQBFIbmHdNdnf6TqpesMQFIUlMBMxrJv6WtmpstM
# Eq78g1VILnNhmcMLBOkfuYdeOuLZMJNhXL+yxGf7GMO6f+PkxAQVjzsN8mr4MqwD
# YhPgTHpytN8OslxaP19CzPuo7I2kuOcS6YR00JkkiH3bRuvrG/qkCq2Uo6SPkZNF
# 0CI0UdN+6aNgHNPrPheTyGo3bDbxJ4BUezFWDPAJTfbo8mS/RnME5/A594jBE3Bk
# ECswfdB6EVsKdSOUgZllj4g2H0ZSwmE21SSp1xSOMMxkyV6To0NnNqjMzlHJddSj
# ql29DQkZqZVPIu9ZW3J+mTeGwZ3MN5ZCe/pc5ri7kEzESQaR
